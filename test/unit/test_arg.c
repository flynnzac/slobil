...
START_TEST(test_check_length)
{
  ...
  ck_assert_int_eq(task0->task->onbu_error, 0);
  ck_assert_int_ne(task0->task->onbu_error, 1);
  ...
  ck_assert_int_ne(task0->task->onbu_error, 0);
  ck_assert_int_eq(task0->task->onbu_error, 1);
