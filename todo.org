...
* DONE op_last should error if no value found with prefix or return an error code (i.e. a register like /0 which could not normally be used).  Currently returns prefix0.
