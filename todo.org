...
** TODO Hash element names before calling statements
** TODO Instructions at #0 should not be copied to new registry
** TODO If register already exists, do not delete it.  Just replace its data.
