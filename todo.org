...
* TODO How to make hash table argument pass fast

replace gen_arg_reg with a hashtable equivalent that has just what is needed for a statement

Main blocker to making it main branch
