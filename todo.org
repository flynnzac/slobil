...
* TODO Make references work with slash notation
* TODO Decision not to make registers "work" with slash notation
...
set @namespace [ reg . ] .
set @func1 ( ... ) \namespace .
* TODO Decide whether to use #1 or _1 or similar
@#1 #1
@_1 _1
@:1 :1
@1- 1-
...
@,1 ,1
@~1 ~1
* TODO Really need to clean up do-to-all, join, and collapse code.  It's bad.
