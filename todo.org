...
* TODO Add "where" command to return all elements of a registry in a list

* TODO Document that colon syntax does not allow substatements within that colon (this is fine, but it should be known)
...
* TODO Add support for in-out parameters?

* TODO Segfault with colon notation when nothing is provided after the colon (should just be a syntax error)

* TODO Interact with ARBEL interpreter through sockets

Could be useful to have a Registry loaded and modify it

* TODO Check with op_read_line
