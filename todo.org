...
* DONE An operation that does nothing but "lookup" all arguments.  To evaluate active instructions. `sit` is a good candidate
  CLOSED: [2020-01-07 Tue 10:31]
...
* DONE do-to-all should have a prefix option like similar instructions, order of registry and instruction should be same
  CLOSED: [2020-01-05 Sun 17:45]
...
* CANCELLED op_last should error if no value found with prefix or return an error code (i.e. a register like /0 which could not normally be used).  Currently returns prefix0.
  CLOSED: [2020-01-05 Sun 18:39]

  - State "CANCELLED"  from "DONE"       [2020-01-08 Wed 14:01] \\
    Actually decided this behavior is useful
...
* CANCELLED Make sure to add a way to change error stop threshold.
  CLOSED: [2020-01-07 Tue 10:28]

  - State "CANCELLED"  from "TODO"       [2020-01-07 Tue 10:28] \\
    I think the default is fine for now
...
=======
  CLOSED: [2019-12-26 Thu 22:18]
>>>>>>> 1abdadc28797d5b0708fd50508e8fc909c64066b
...
* DONE Use Macro for the Operator's type checking and arg counting
  CLOSED: [2020-01-07 Tue 10:24]

* DONE Use Unicode for Strings and input (i.e. allow instructions to have unicode characters)
  CLOSED: [2020-01-07 Tue 10:24]

In UTF-8

* DONE to-real should work with Strings too
  CLOSED: [2020-01-07 Tue 10:27]
* DONE Update enumeration to have the type case (String, Integer, etc) so that the macros work more naturally
  CLOSED: [2020-01-07 Tue 10:24]
* DONE Modify Emacs mode so that "#" stay at natural indent
  CLOSED: [2020-01-05 Sun 17:46]
* DONE Fix call "call" with no args
  CLOSED: [2020-01-07 Tue 10:24]
* TODO enum operation to create integer values at given registers (maybe standard library?)
* TODO Document new error-code register
* TODO In interpretation documentation

One idea is to attach a documentation object to data.

Another idea is to add a document to some cache.

Let's go with the cache.  Should be able to do it in ARBEL itself.
* TODO Let ARBEL take a command-line registry like so:

  - State "TODO"       from "CANCELLED"  [2020-01-16 Thu 12:58]
./arbel -s script.arb -r "/x 10 /y \"hello\" ... "

I think something like this would be cleaner (and is do-able).

./arbel /x 10 /y "hello" -s script.arb



* DONE Add "where" command to return all elements of a registry in a list
  CLOSED: [2020-01-29 Wed 15:26]

* DONE Document that colon syntax does not allow substatements within that colon (this is fine, but it should be known)
  CLOSED: [2020-01-29 Wed 15:26]

* DONE option to not stop command list on error
  CLOSED: [2020-01-11 Sat 00:20]
>>>>>>> 02e2ac80e26925e83a0e93f4654fd298512fe631

* DONE Sales Pitch on ARBEL
  CLOSED: [2020-01-16 Thu 12:57]

** Naturally generic

** Can control when substatements are evaluated so <or> can both short-circuit and execute both substatements.

* DONE Make sure {}'s can be used in user-defined instructions without being effectively []'s
  CLOSED: [2020-01-16 Thu 12:25]

* DONE Find a solution for shebang #!
  CLOSED: [2020-01-16 Thu 12:57]

I think the easiest way is to add a command line option which skips
first line...

* CANCELLED Add support for in-out parameters?
  CLOSED: [2020-01-29 Wed 15:26]

  - State "CANCELLED"  from "TODO"       [2020-01-29 Wed 15:26] \\
    Can be achieved with <up> instruction, no need to add a complication
* DONE Segfault with colon notation when nothing is provided after the colon (should just be a syntax error)
  CLOSED: [2020-01-29 Wed 15:27]

* TODO Interact with ARBEL interpreter through sockets

Could be useful to have a Registry loaded and modify it

* DONE Check with op_read_line
  CLOSED: [2020-01-29 Wed 15:27]

* DONE Fix bug from an old, hardcoded buffer size for input
  CLOSED: [2020-01-23 Thu 11:10]
