...
* TODO Use Macro for the Operator's type checking and arg counting

* TODO Use Unicode for Strings and input (i.e. allow instructions to have unicode characters)
* TODO to-real should work with Strings too
* TODO Update enumeration to have the type case (String, Integer, etc) so that the macros work more naturally
* DONE Modify Emacs mode so that "#" stay at natural indent
  CLOSED: [2020-01-05 Sun 17:46]
* TODO Fix call "call" with no args
