...
** TODO  2: while needs to be re-instated

** TODO  3: Need to be able to enter multi-line code on prompt again

** TODO  4: Memory-management for instructions and statement structures
